...
if True:  # TREINAMENTO
    ...
    model_unit_01 = train_model(input_positions_unit_01, delta_input=0.2, delta_output=0.5, model_class=LSTMModel, epochs=20, batch_size=8, learning_rate=0.0001)
    model_unit_02 = train_model(input_positions_unit_02, delta_input=0.2, delta_output=0.5, model_class=LSTMModel, epochs=20, batch_size=8, learning_rate=0.0001)
